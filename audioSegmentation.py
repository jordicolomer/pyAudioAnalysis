...
def trainHMM_fromFile(wavFile, gtFile, hmmModelName, mtWin, mtStep):
    ...
    hmm = hmmlearn.GaussianHMM(startprob.shape[0], "diag", startprob, transmat)            # hmm training
    hmm.means_ = means
    hmm.covars_ = cov
...
def trainHMM_fromDir(dirPath, hmmModelName, mtWin, mtStep):
    ...
    hmm = hmmlearn.GaussianHMM(startprob.shape[0], "diag", startprob, transmat)      # train HMM
    hmm.means_ = means
    hmm.covars_ = cov
